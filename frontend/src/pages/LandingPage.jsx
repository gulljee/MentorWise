        ...
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <nav className="fixed top-0 w-full z-50 bg-transparent backdrop-blur-xl">
                <div className="flex justify-between items-center px-4 sm:px-8 py-4 max-w-7xl mx-auto">
                    ...
                    <div className="hidden lg:flex items-center space-x-8 font-semibold text-sm tracking-tight">
                    ...
                    <div className="flex items-center space-x-2 md:space-x-4">
                        <button
                            ...
                            className="hidden sm:block px-5 py-2 text-sm font-semibold text-blue-900 transition-all hover:bg-slate-100/50 rounded-lg"
                        >
                            Login
                        </button>
                        <button
                            onClick={() => navigate("/signup")}
                            className="px-4 py-2 md:px-6 md:py-2.5 text-xs md:text-sm font-semibold bg-gradient-to-br from-primary to-primary-container text-white rounded-md shadow-lg shadow-primary/10 hover:scale-95 transition-all"
                        >
                            Sign Up
                        </button>
                        {/* Mobile Menu Toggle */}
                ...
                {/* Mobile Menu Overlay */}
                {isMenuOpen && (
                    <div className="lg:hidden absolute top-full left-0 w-full bg-white border-b border-slate-100 shadow-xl p-6 animate-in slide-in-from-top duration-300">
                        <div className="flex flex-col space-y-4 font-semibold text-sm">
                            <a 
                                className="text-slate-600 hover:text-blue-900 py-2 border-b border-slate-50" 
                                href="#process"
                            ...
                            <a 
                                className="text-slate-600 hover:text-blue-900 py-2 border-b border-slate-50" 
                                href="https://mail.google.com/mail/?view=cm&fs=1&to=gull66332@gmail.com"
                                onClick={() => setIsMenuOpen(false)}
                            >
                                Contact
                            </a>
                            <button
                                ...
                                className="text-blue-900 py-2 text-left"
                            >
                                Login
                            </button>
                        </div>
            ...
            <main>
                <section className="relative min-h-screen flex items-center pt-20 px-8 bg-surface overflow-hidden">
                    <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
                        <div className="z-10 text-center md:text-left">
                            ...
                            <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl font-extrabold text-primary leading-[1.1] tracking-tight mb-8">
                                Bridge the Gap <br className="hidden md:block" />
                                <span className="text-primary-container">Between Ambition</span> and Experience
                            </h1>
                            <p className="text-base md:text-lg text-on-surface-variant max-w-lg mx-auto md:mx-0 mb-10 leading-relaxed">
                        ...
                        <div className="relative mt-12 md:mt-0">
                            <div className="absolute -top-10 -right-10 md:-top-20 md:-right-20 w-64 h-64 md:w-96 md:h-96 bg-secondary-fixed/20 rounded-full blur-3xl"></div>
                            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl transform md:rotate-2 hover:rotate-0 transition-transform duration-700">
                                <img
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-8">
                            <div className="max-w-xl text-center md:text-left">
                                ...
                                <h2 className="font-headline text-3xl md:text-5xl font-extrabold text-primary mt-4">Three Steps to Mastery</h2>
                                <p className="mt-6 text-on-surface-variant text-base md:text-lg">
                ...
                <section id="benefits" className="py-20 md:py-32 px-8 bg-surface">
                    <div className="max-w-7xl mx-auto">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">

                            <div className="space-y-8 md:space-y-12">
                                <div className="relative inline-block">
                                    <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-primary mb-2">For Mentees</h2>
                                ...
                                <div className="space-y-6 md:space-y-8">
                                    <div className="flex gap-4 md:gap-6 items-start">
                                        ...
                                        <div>
                                            <h4 className="font-headline text-lg md:text-xl font-bold text-primary mb-1">Navigate Transitions</h4>
                                            <p className="text-sm md:text-base text-on-surface-variant">Smooth out the bumps between high school and uni, or junior and senior years.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 md:gap-6 items-start">
                                        <div className="p-3 bg-surface-container rounded-lg flex-shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-headline text-lg md:text-xl font-bold text-primary mb-1">Gain Peer Insights</h4>
                                            <p className="text-sm md:text-base text-on-surface-variant">Practical advice on campus life, professor expectations, and hidden resources.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 md:gap-6 items-start">
                                        <div className="p-3 bg-surface-container rounded-lg flex-shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-headline text-lg md:text-xl font-bold text-primary mb-1">Academic Support</h4>
                                            <p className="text-sm md:text-base text-on-surface-variant">Focus your study efforts where they matter most based on peer-tested strategies.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div className="mt-8 lg:mt-24 space-y-8 md:space-y-12 p-8 md:p-12 bg-surface-container-low rounded-3xl border border-outline-variant/10">
                                <div className="relative inline-block">
                                    <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-primary mb-2">For Mentors</h2>
                                ...
                                <div className="space-y-6 md:space-y-8">
                                    <div className="flex gap-4 md:gap-6 items-start group">
                                        ...
                                        <div>
                                            <h4 className="font-headline text-lg md:text-xl font-bold text-primary mb-1">Leadership Experience</h4>
                                            <p className="text-sm md:text-base text-on-surface-variant">Hone your management and coaching skills, highly valued by future employers.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 md:gap-6 items-start group">
                                        <div className="p-3 bg-white rounded-lg shadow-sm group-hover:bg-primary transition-colors flex-shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-headline text-lg md:text-xl font-bold text-primary mb-1">Network Growth</h4>
                                            <p className="text-sm md:text-base text-on-surface-variant">Connect with high-potential juniors and fellow senior mentors across faculties.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 md:gap-6 items-start group">
                                        <div className="p-3 bg-white rounded-lg shadow-sm group-hover:bg-primary transition-colors flex-shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-headline text-lg md:text-xl font-bold text-primary mb-1">Give Back</h4>
                                            <p className="text-sm md:text-base text-on-surface-variant">Make a tangible difference in a fellow student's life and university experience.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="py-20 md:py-24 px-6 md:px-8">
                    <div className="max-w-5xl mx-auto bg-gradient-to-br from-primary to-primary-container rounded-3xl p-8 sm:p-12 md:p-20 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h2 className="font-headline text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">Ready to start your journey?</h2>
